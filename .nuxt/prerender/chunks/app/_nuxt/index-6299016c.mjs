...
import { useSSRContext, ref, watch, mergeProps, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString } from 'file://C:/Projects/nuxt/node_modules/vue/index.mjs';
import { u as useCookie } from './cookie-daf610f3.mjs';
import { u as useLocalePath } from './composables-2c3efc9a.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrRenderStyle } from 'file://C:/Projects/nuxt/node_modules/vue/server-renderer/index.mjs';
...
import { _ as __nuxt_component_0 } from './nuxt-img-9957c8cb.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(unref(Campaigns), (slide, i) => {
              _push2(ssrRenderComponent(unref(Z), { key: i }, {
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(Campaigns), (slide, i) => {
                return openBlock(), createBlock(unref(Z), { key: i }, {
                  content: withCtx(() => [
                    createVNode("div", {
                      class: "vueperslide__content-wrapper",
                      style: { "flex-direction": "column" }
...
//# sourceMappingURL=index-6299016c.mjs.map
