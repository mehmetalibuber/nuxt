...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://C:/Projects/nuxt/node_modules/h3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Projects/nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Projects/nuxt/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Projects/nuxt/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/Projects/nuxt/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Projects/nuxt/node_modules/ufo/dist/index.mjs';
...
import robots from 'file://C:/Projects/nuxt/.nuxt/robots.mjs';
...
import { isAbsolute } from 'file://C:/Projects/nuxt/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file://C:/Projects/nuxt/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Projects/nuxt/node_modules/unhead/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Projects\\nuxt\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _KRMaeNdKf3 = (function(nitro) {
...
const _lazy_WK9Noo = () => Promise.resolve().then(function () { return renderer$1; });
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"stylesheet","href":"/lib/Bootstrap/bootstrap.min.css"},{"rel":"stylesheet","href":"/css/mainLayout.css"},{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[{"src":"/lib/Bootstrap/bootstrap.bundle.min.js"}],"noscript":[],"htmlAttrs":{"lang":"tr-TR"}};
...
const getClientManifest = () => import('file://C:/Projects/nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Projects/nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
