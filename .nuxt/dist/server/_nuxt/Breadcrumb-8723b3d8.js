...
const Breadcrumb_vue_vue_type_style_index_0_scoped_f27c2455_lang = "";
const _sfc_main = {
  __name: "Breadcrumb",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span><span data-v-f27c2455> / </span><span data-v-f27c2455>${ssrInterpolate(_ctx.$t(__props.PageTitle))}</span></div></div></section>`);
    };
  }
};
...
//# sourceMappingURL=Breadcrumb-8723b3d8.js.map
