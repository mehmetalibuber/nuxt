import { h as useI18n, u as useRouter, d as useRoute, f as useRuntimeConfig, e as useNuxtApp } from "../server.mjs";
import { computed, mergeProps, unref, useSSRContext, ref, withCtx, createTextVNode, toDisplayString, createVNode, createSlots, renderList, renderSlot } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderComponent, ssrRenderSlot } from "vue/server-renderer";
import { _ as __nuxt_component_0$2 } from "./nuxt-link-01469011.js";
...
import { _ as _imports_0$2 } from "./call-center-3ecc2d8e.js";
import { _ as _imports_2 } from "./logout-de4be0e0.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import "hookable";
import { Vue3Snackbar } from "vue3-snackbar";
import { _ as __nuxt_component_0$3 } from "./nuxt-img-c52e0bac.js";
const LangSwitcher_vue_vue_type_style_index_0_lang = "";
const _sfc_main$5 = {
...
const _imports_1 = "" + __publicAssetsURL("assets/icons/user.png");
const TopHeader_vue_vue_type_style_index_0_scoped_23191695_lang = "";
const _sfc_main$4 = {
  __name: "Top-Header",
  __ssrInlineRender: true,
  setup(__props) {
...
const _imports_0$1 = "" + __publicAssetsURL("assets/layout/geccele-logo.png");
const Header_vue_vue_type_style_index_0_scoped_366f7f81_lang = "";
const _sfc_main$3 = {
  __name: "Header",
  __ssrInlineRender: true,
  setup(__props) {
...
const CookieAccept_vue_vue_type_style_index_0_scoped_cc167e5c_lang = "";
const _sfc_main$1 = {
  data() {
    return {
...
const _imports_0 = "" + __publicAssetsURL("assets/icons/youtube.png");
const Footer_vue_vue_type_style_index_0_scoped_31acf5dd_lang = "";
const _sfc_main = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`  ${ssrInterpolate(_ctx.$t("BeInformedOfCampaigns"))}</div></div><div class="col-lg-6" data-v-31acf5dd><div class="row" data-v-31acf5dd><div class="col-xl-3 col-lg-4 title" data-v-31acf5dd><h2 data-v-31acf5dd><b data-v-31acf5dd>${ssrInterpolate(_ctx.$t("Company"))}</b></h2><ul data-v-31acf5dd><li data-v-31acf5dd>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</h2><p class="mt-3" data-v-31acf5dd><b data-v-31acf5dd>${ssrInterpolate(_ctx.$t("CallUs"))}</b></p><a id="tel"${ssrRenderAttr("href", "tel:" + unref(PhoneNumber))}${ssrRenderAttr("title", unref(PhoneNumber))} data-v-31acf5dd>${ssrInterpolate(unref(PhoneNumber))}</a><p data-v-31acf5dd>${ssrInterpolate(_ctx.$t("Or"))}</p><span title="Call Me" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-bs-toggle="modal" data-bs-target="#callbackModal" data-v-31acf5dd><b data-v-31acf5dd>${ssrInterpolate(_ctx.$t("WeCallYou"))}</b>   `);
      _push(ssrRenderComponent(_component_NuxtImg, {
        class: "icon align-self-center",
        style: { "margin-top": "0" },
...
//# sourceMappingURL=Footer-61936d79.js.map
