import { hasInjectionContext, getCurrentInstance, version, unref, inject, toRef, isRef, defineComponent, h, onUnmounted, ref, computed, watch, Fragment, createApp, effectScope, reactive, useSSRContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, Text, defineAsyncComponent, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, Suspense, Transition } from 'vue';
import { d as useRuntimeConfig$1, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, $ as $fetch, n as getContext, o as sanitizeStatusCode, q as createHooks, r as parse$1, t as serialize, v as isEqual, x as getRequestHeaders, y as defu } from '../nitro/node-server.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./_nuxt/index-a914c0bb.mjs').then((m) => m.default || m)
  },
  {
...
const layouts = {
  authentication: () => import('./_nuxt/authentication-2158e1cd.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-bfda995c.mjs').then((m) => m.default || m),
